...
public class Server implements ActionListener{
    ...
    Server(){ //to creat the window
        ...
        ImageIcon serverpp=new ImageIcon(ClassLoader.getSystemResource("icons/serverpp.jpg")); //image location
        ...
        f.setLocation(200,50); //position of window
    ...
    public static void main(String[] args)
    {
        ...
        try{
            ServerSocket skt = new ServerSocket(1930);
            while(true){
                Socket s = skt.accept();
